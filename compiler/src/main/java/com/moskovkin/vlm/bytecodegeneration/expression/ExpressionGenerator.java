...
//    private final ConditionalExpressionGenerator conditionalExpressionGenerator;
    ...
    public ExpressionGenerator(MethodVisitor methodVisitor, ClassDeclaration classDeclaration) {
        referenceExpressionGenerator = new ReferenceExpressionGenerator(methodVisitor,classDeclaration);
        valueExpressionGenerator = new ValueExpressionGenerator(methodVisitor);
        callExpressionGenerator = new CallExpressionGenerator(this, classDeclaration, methodVisitor);
...
//        conditionalExpressionGenerator = new ConditionalExpressionGenerator(this, methodVisitor);
        parameterExpressionGenerator = new ParameterExpressionGenerator(methodVisitor, classDeclaration);
    }
